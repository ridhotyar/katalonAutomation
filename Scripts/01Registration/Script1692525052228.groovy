...
WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Last Name_lastname'), 'Tiyar')

WebUI.click(findTestObject('Object Repository/Page_Create New Customer Account/input_Last Name_is_subscribed'))

WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Email_email'), GlobalVariable.Email)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Create New Customer Account/input_Password_password'), GlobalVariable.Password)
